...
**Group:** 5 — Ajay, Candice, Zara (7), Kai (9), grandma (Seck Joo Lee, 75)
**Dates:** May 29 – June 8, 2026 (10 nights)
**Pacing:** Active mornings · Slow afternoons · Interesting evenings
**Planning model:** Each day has **🔒 LOCKED** commitments (booked/time-sensitive) and **🎯 FLEXIBLE** slots picked day-of from [menus/](menus/).
...
> **Jet lag day. Don't plan more.** Everyone's been awake ~20 hours. Goal: shower, eat something simple, sleep.
...
- **teamLab Planets Tokyo** (Toyosu) — entry **14:00–14:30** · 3 adults + 2 kids · inquiry # `61d3669eb033ddea8a` ✅ booked
  - May wait up to 30 min in the admission queue on top of the entry window
...
🎯 **FLEXIBLE**
- Morning: pack-and-depart morning. Optional **M5 Akihabara** (Ajay-led, grandma rests) if energy is high — but it competes with the 13:00 Romancecar departure, so likely skip.
- Afternoon at Rakuten STAY: settle in, kitchen / Family Mart trip, family rest. **No on-site onsen** at this property — onsen plan is Yunessun on Day 6.
- Evening: dinner — **either** the **Fujiya Hotel Main Dining Room kaiseki** (smart-casual, dinner-only reservation; book ~1 month out · ⬜) **or** local Kowakudani izakaya / self-catered in the unit. *(Default: do Fujiya kaiseki on Day 6 instead — see below.)*
...
## Day 9 — Sat Jun 6 · Nara Day Trip + Kaiseki Dinner

🔒 **LOCKED**
- **Morning before leaving for Nara:** hand bags to **Stitch front desk** for **takkyubin Leg 3** (Kyoto → Richmond Hotel Narita) — bags arrive Narita Sun Jun 7 evening
  - ⚠️ **Pack 2 days of essentials in day-pack** (Sat Jun 6 + Sun Jun 7) before this hand-off
- **Kaiseki farewell dinner** in Kyoto · ⬜ *book via Stitch front desk on arrival OR 1–2 months ahead — Kikunoi Roan / Kiyamachi Sakuragawa / Giro Giro Hitoshina (KE2 in [menus/kyoto.md](menus/kyoto.md))*

🎯 **FLEXIBLE**
- **N1 Nara Park + Todai-ji** day trip — JR Miyakoji Rapid Kyoto → Nara, 45 min, ~¥720/person. Deer + Great Buddha + Naramachi stroll. Back to Kyoto by ~16:00 for kaiseki dinner.
- Alt: skip Nara if family is tired and pick a Kyoto block instead (K2 Arashiyama or K4 Imperial Palace + Nishiki)

> **Critical:** Leg 3 takkyubin send is THIS morning — not Day 10. Day 10 is just transit; bags ride ahead independently.
...
## Day 11 — Mon Jun 8 · Departure (split day)
...
🎯 **FLEXIBLE**
- Family morning: hotel breakfast, optional 30-min Naritasan Park walk
- Late morning: light lunch (or konbini bento for the plane), check out by 11:00
- **~13:00** Family taxi or Keisei line Narita → NRT (10 min, ¥2,500 / ¥260)
- **~13:30** At NRT for 16:25 ZG030 — ZIPAIR check-in closes 1h pre-flight (15:25)
...
| Kyoto ↔ Nara | JR Miyakoji Rapid | 45 min | ~¥7,200 RT | Day 9 |
| Kyoto → Tokyo Station | Shinkansen Nozomi | ~2h 20min | ~¥67,500 | Reserved × 5 · book May 7 |
| Tokyo Station → Narita | NEX | ~60 min | ~¥15,000 | Reserved × 5 |
| Narita → NRT (grandma) | Taxi | 10 min | ~¥2,500 | 5:30am pre-booked at hotel |
| Narita → NRT (family) | Taxi or Keisei | 10 min | ~¥2,500 / ¥260 | Family choice |

**JR Pass math:** Not worth it. Individual reserved Shinkansen ~¥132,500 + NEX/Romancecar/local <¥50,000 ≈ **¥180,000** vs ~¥225,000+ for 7-day JR Pass × 5 pax. **Skip it.** (Plus we ship bags via takkyubin so we're not exploiting JR Pass for Shinkansen oversize-bag avoidance either.)

**Takkyubin luggage forwarding:** 3 legs (drops Jun 1, Jun 3, Jun 6 mornings). ~¥35,000–45,000 total.

---

## Bookings Status (snapshot)

> Single source of truth for outstanding tasks: [todos.md](todos.md)
