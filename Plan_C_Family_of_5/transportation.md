...
- **Medications** (especially grandma's — never put in checked/takkyubin)
...
- Any liquid >100ml (don't risk it through ZIPAIR carry-on)
...
## 🚆 Day-by-Day Transit (people only — bags handled separately)

> Each section below is **just** the people's path. Bags travel ahead via takkyubin per the plan above.
...
| 06:20 | Grandma | At terminal for 08:20 NRT → SIN |
...
| 11:00–13:00 | Family | Light lunch on Omotesando (or konbini) |
| ~13:00 | Family | **Taxi or Keisei line** Narita Hotel → NRT (10 min) · taxi ~¥2,500, Keisei ¥260/person |
| 13:30 | Family | At NRT for 16:25 ZG030 |
| 16:25 | Family | Wheels up SJC-bound |

**Bag logistics:** All bags accompany the people on this day — they're flying out. ZIPAIR rules apply.

**Critical pre-arrival task at Richmond Hotel:** book grandma's 5:30am taxi at reception **at check-in Jun 7 evening**. Don't leave it until morning.
...
## 🍱 Food + Reservations on Transit Days

- **Day 7 (Hakone → Kyoto):** Eat **early lunch** in Hakone before checkout, OR buy **ekiben** at Odawara Station for the Shinkansen ride. Odawara has a famous "kamameshi bento" stand — worth trying.
- **Day 10 (Kyoto → Narita):** Buy **ekiben** at Kyoto Station — the lunch on the Shinkansen is part of the trip's romance. Try a **bento with Kyoto-style yuba or grilled fish**.
...
- [ ] **Google Maps offline map** of Tokyo, Hakone, Kyoto, Narita downloaded in advance
- [ ] **¥30,000 cash starter** — exchange a small amount in advance; ATMs in 7-Eleven konbinis work well for the rest
- [ ] **Travel adapter × 2** — Japan uses Type A (same as US, mostly), but voltage is 100V not 120V. Most chargers handle this; check power-hungry items (hair dryer, etc.)
- [ ] **Portable battery pack × 2 family** — long transit days
...
## 💰 Total Transportation Cost Estimate (5 pax)
...
- Flight bookings: [`bookings/flights.md`](../bookings/flights.md)
- Tokyo lodging: [`bookings/tokyo_lodging.md`](../bookings/tokyo_lodging.md)
- Hakone lodging: [`bookings/hakone_lodging.md`](../bookings/hakone_lodging.md)
- Kyoto lodging: [`bookings/kyoto_lodging.md`](../bookings/kyoto_lodging.md)
- Narita lodging: [`bookings/narita_lodging.md`](../bookings/narita_lodging.md)
- teamLab Planets: [`bookings/teamlab.md`](../bookings/teamlab.md)
- Day-by-day plan: [`itinerary.md`](itinerary.md)
