# ✈️ Flights — ZIPAIR (BOOKED)

**Confirmation:** `GE7DVP`
**Airline:** ZIPAIR Tokyo ([zipair.net](https://www.zipair.net))
**Booked:** 2026-03-23
**Contact on booking:** candice.kao@gmail.com · +1 650-384-3393

> ⚠️ ZIPAIR is a low-cost carrier. Check-in closes **1 hour before departure**. No transfer services. Bags and meals are fee-based (meals already selected, see below).

---

## Route Summary

| Leg | Flight | From | To | Depart (local) | Arrive (local) |
|-----|--------|------|-----|----------------|----------------|
| Outbound | **ZG029** | San Jose (SJC) | Narita (NRT) | **Thu 2026-05-28, 11:40** | **Fri 2026-05-29, 14:50** |
| Return | **ZG030** | Narita (NRT) | San Jose (SJC) | **Mon 2026-06-08, 16:25** | **Mon 2026-06-08, 09:40** |

**Nights in Japan: 10** (arrive May 29 afternoon → depart June 8 afternoon)
...
## 5th Traveler — Seck Joo Lee (Candice's mom)

Joining for the Japan portion; continues on to Singapore after, not returning to the US with the family.

### Arrival — ZIPAIR F0F2P9 ✅

Same flight as the family (ZG029 out of SJC). An earlier booking (4SC657, SFO→NRT on ZG025) was canceled and replaced by this one.

| Field | Value |
|-------|-------|
| Confirmation | `F0F2P9` |
| Flight | **ZG029** (same as family) |
| Route | San Jose (SJC) → Narita (NRT) |
| Depart | 2026-05-28 (Thu) 11:40 |
| Arrive | 2026-05-29 (Fri) 14:50 |
| Seat | **51H** (window) — family is in 51A/C/D/G, so she's in the same row |
| Fare class | ZIP STANDARD VALUE (L1ZSA0B) + VALUE bundle |
| Meal | Chicken Teriyaki |
| Bag | 30 kg checked (fee-based) |
| Paid | $706.50 (VISA) |
| Booked | 2026-03-23 |
...
- **June 8 morning:** grandma takes pre-booked taxi ~5:30am to NRT (~10 min, ~¥2,500) for her 8am SIN flight.
- **June 8 midday:** family leisurely breakfast + final Narita wander, head to NRT ~13:30 for the 16:25 ZG030 departure.

---

## Key Implications for Trip Planning

1. **Group in Japan is 5** (4 from SJC + Seck Joo Lee from SFO). Both existing plan drafts (A: family of 5 without grandma; B: family of 6 with grandma) mis-model the composition. Plan A's room configs are closer, but swap 3 kids → 2 kids + grandma.
2. **Hard dates: May 29 – June 8, 2026 (10 nights).** No flexibility.
3. **Arrive Narita afternoon May 29** — Day 1 is a soft landing; check-in and konbini dinner only.
4. **Depart Narita 16:25 June 8** — need to be at NRT by ~14:30. Last full day in Japan is June 7; June 8 is a travel-out morning.
5. Hotel night count to book: **10 nights**, ending the morning of June 8.
