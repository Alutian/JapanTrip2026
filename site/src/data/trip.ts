...
export const DAYS: Day[] = [
  ...
  },
  {
    ...
    prep: {
      ...
      items: [
        '🥢 **Pre-lock dinner option.** Mutekiya = tonkotsu = pork (kids only, adults can\'t). Better adult-fits: AFURI Ikebukuro (chicken-yuzu shio, no-pork) OR Sushiro / Genki / Sushiro at Sunshine City Alpa B1 (conveyor-belt sushi — Day 2 win). Don\'t walk to Ikebukuro without a pick.',
        '🐖 **Pork pre-check.** Zara almost ate pork xiao long bao yesterday — Nakamise + Hoppy St have pork-heavy stalls. Ask before ordering.',
    ...
    momentCards: [
      ...
      {
        emoji: '🎫',
        title: 'Replace 2 broken Welcome Suica — Tokyo Station JR East counter',
        time: '~08:00–08:20 (on the way to Asakusa)',
        lines: [
          '**JR East Travel Service Center, Tokyo Station Marunouchi Central Exit (1F)** — opens 07:30, Sundays included.',
          '**Bring the 2 broken cards + passports** (kid-fare verification, same as Day 1). They may swap or issue 2 new ones.',
          'Welcome Suica = no deposit, no end-of-trip refund needed. Top up ~¥3,000 adult / ¥2,000 kid at the same counter.',
          'Route: Marunouchi line Yotsuya-sanchome → Otemachi (3 stops) → 5 min walk to Tokyo Station, OR JR Chuo Yotsuya → Tokyo (4 stops direct).',
        ],
        mapQuery: 'JR East Travel Service Center Tokyo Station Marunouchi Central Exit',
        mapLabel: 'Tokyo Station JR East counter',
        accent: 'accent',
      },
      {
        emoji: '🚇',
        title: 'Tokyo Station → Asakusa',
        time: '~08:30',
        lines: [
          '**Ginza line Tokyo → Asakusa** (8 stops direct, ~17 min, ¥210). No transfer.',
          'Arrive Asakusa ~08:45 — beats the Senso-ji 09:30 tour-bus rush.',
        ],
      ...
      },
      {
        ...
        time: '~17:30–18:30',
        lines: [
          '**Top pick: conveyor-belt sushi inside Sunshine City** (Sushiro or similar in Alpa B1) — replicates Day-2 win, kids ate happily, no-pork easy.',
          '**Alt: AFURI Ikebukuro** — chicken-yuzu shio ramen, no pork, 10 min walk from Sunshine. Light + flavorful.',
          '**Mutekiya tonkotsu** = kid-favorite tonkotsu BUT pork broth. Adults can\'t eat = bad call after Day-2 retrospective. Skip unless kids insist + adults eat earlier.',
  ...
  },
  {
    ...
    plan: [
      ...
      'Evening (E6): Omoide Yokocho yakitori (P1) — Uchu for standard chicken skewers (no-pork: stick to chicken, avoid butabara). Walk-in. Cash.',
