...
export const DAYS: Day[] = [
  ...
  },
  {
    ...
    title: 'Harajuku → Shibuya → Tochomae',
    cluster: 'MiPig morning · Shibuya neon · Tocho night show · Omoide Yokocho yakitori',
    crossLinks: [
    ...
    momentCards: [
      ...
      },
      {
        ...
        lines: [
          ...
          '~5 min walk from Shibuya Station east exit.',
          'Pokémon Center has exclusive Shibuya plushies. Nintendo Tokyo has Switch demo stations.',
        ],
      ...
      {
        emoji: '🚦',
        title: 'Shibuya Scramble at dusk',
        time: '~18:15–18:45',
        lines: [
          'Cross it once on foot. Sunset is **18:55** — best light during this window.',
          '**Best photo spot:** Q-Front Starbucks 2F windows (buy a coffee, get the iconic overhead shot). Free.',
          'Then walk it at street level for the crowd-energy feel.',
        ],
        mapQuery: 'Shibuya Scramble Crossing',
        mapLabel: 'Scramble in Maps',
      },
      {
        emoji: '🚇',
        title: 'Shibuya → Tochomae',
        time: '~19:00–19:15',
        lines: [
          'Oedo line Shibuya → Tochomae (~10 min, ~¥210). Direct, no transfer.',
          'Welcome Suica covers it.',
        ],
        mapQuery: 'Tochomae Station Tokyo',
        mapLabel: 'Tochomae Station',
      },
      {
        emoji: '🌃',
        ...
        time: '~19:45–20:15',
        lines: [
          '**Tokyo Metropolitan Government Building** (Tochomae) — projection mapping on the twin towers, ~15 min per show, **free**, runs nightly.',
      ...
      {
        emoji: '🍢',
        title: 'Dinner — Omoide Yokocho yakitori',
        time: '~20:30–21:30',
        lines: [
          '**Shinjuku west side** — atmospheric narrow-alley yakitori, ~10 min walk from Tochomae OR train Tochomae → Shinjuku (1 stop, Oedo).',
          'P1 wishlist (moved here from Day 4). Walk-ins fine at most stalls.',
          '**Family-friendly pick: Uchu** (standard yakitori, English-friendly). Adventurous: Asadachi.',
          'No-pork: stick to chicken skewers (negima, momo, sasami, tsukune). Avoid butabara.',
          'Cash-only at most stalls — bring ¥10,000 across the family.',
        ],
        mapQuery: 'Omoide Yokocho Shinjuku',
        mapLabel: 'Omoide Yokocho in Maps',
        accent: 'accent',
      },
      {
        emoji: '🚶',
        title: 'Walk back to Yotsuya',
        time: '~21:30–22:00',
        lines: [
          'Shinjuku → Yotsuya: Marunouchi line 1 stop to Yotsuya-sanchome (~5 min) OR walk ~25 min via Shinjuku Gyoen perimeter.',
          'Optional last bite: Ramen Ouka (Shinjuku-gyoenmae, halal/no-pork) if anyone\'s still hungry — but probably not after Yokocho.',
        ],
      },
    ],
    plan: [
      '🛏️ Home by ~22:00. Day 3 is Asakusa — earlier start than today.',
    ],
  ...
  },
  {
    ...
    plan: [
      ...
      'Evening: light — teamLab is intense; both prior E6 anchors (Omoide Yokocho + Metro Night Show) moved to Day 2 after Shibuya Sky sold out.',
      'Dinner: walk-in near Yotsuya — Ramen Ouka (halal/no-pork, 5 min from Shinjuku-gyoenmae) or konbini if shattered.',
