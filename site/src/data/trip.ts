...
export const DAYS: Day[] = [
  ...
  },
  {
    ...
    momentCards: [
      {
        ...
        time: '~12:30',
        lines: [
          'Leave the Airbnb by **~12:30**. Marunouchi line **Yotsuya-sanchome → Shinjuku** (1 stop), or ~10-min walk.',
          'Head for the **Odakyu** side / Romancecar platforms (west side of Shinjuku Station).',
        ],
      ...
      {
        emoji: '🎟️',
        title: 'Buy Hakone Free Pass × 5 — Shinjuku, BEFORE boarding',
        time: '~12:50',
        lines: [
          '**Odakyu Sightseeing Service Center, Shinjuku Station** (west side, near the Romancecar platforms).',
          '**2-day pass: ~¥6,100/adult + ~¥1,100/kid ≈ ¥21,500 for 5.** Pay credit card or cash.',
          '⚠️ **This is the critical step:** the Free Pass covers the **Shinjuku→Yumoto base fare** AND all Hakone Tozan/Ropeway/boats/buses for 2 days. The Romancecar **LE surcharge ticket alone won\'t get you through the gate** — you need the Free Pass too. **Do NOT wait to buy it at Yumoto.**',
    ...
    plan: [
      ...
      'Tozan Yumoto → Kowakudani (~25 min, tap Free Pass) → self check-in Rakuten STAY.',
