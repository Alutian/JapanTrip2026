...
export const DAYS: Day[] = [
  ...
  },
  {
    ...
    locked: [
      '~13:45 — Shinkansen Nozomi Kyoto → Tokyo (booked, ~2h 20m, arrive Tokyo ~16:05)',
      'NEX Tokyo → Narita — ALL-RESERVED: book 5 seats together. Target ~18:33 or ~19:03 dep (last NEX 20:02 → Narita 21:14)',
      'Check in Richmond Hotel Narita (3 main bags already here via takkyubin Leg 3)',
      'At check-in: book Popo 5:30am taxi at reception',
    ],
    plan: [
      '⏰ Check out Stitch by 11:00 (checkout window closes 11:00) — store day-bags at front desk for the morning',
      'Slow last Kyoto morning: coffee + souvenirs around Kawaramachi / Nishiki',
      '~16:05 arrive Tokyo Station → stash light bags in coin lockers (Tokyo Stn is the anchor — bags + NEX both depart here, no backtracking)',
      '~16:30–18:05 Akihabara (Yamanote, 4 min): Radio Kaikan (figures + limited-edition souvenirs) → Gachapon Kaikan (kids capsule haul) → Don Quijote (snack + grandma souvenirs); Yodobashi for electronics / arcades for UFO-catchers',
      'Back to Tokyo Station — grab bags + ekiben/bento at Ekibenya Matsuri',
      '🍱 Dinner: eat the ekiben onboard the NEX → Narita (no sit-down stop needed)',
    ],
  },
  {
    n: 11,
