...
export const DAYS: Day[] = [
  ...
  },
  {
    ...
    momentCards: [
      ...
      {
        emoji: '🌆',
        title: 'Evening — pick after lunch on kid energy',
        time: 'from ~16:00',
        lines: [
          '**Toy mission is already done at Skytree, so the Ikebukuro Pokémon run is now optional.** Three live options:',
          '**A — Akihabara neon night** (pulled forward from Day 5). Better after dark: neon, gachapon halls, retro game/toy + figure shops. Clean from Asakusa/Skytree (Ginza/Hanzomon lines). Easy non-pork dinner — chicken/shio ramen, curry, or conveyor sushi. Frees the Day-5 pack-and-go morning.',
          '**B — Ikebukuro as originally planned.** **Pokémon Center MEGA TOKYO** (Sunshine City Alpa B1, largest in Tokyo, till 20:00) + **Gashapon Ikebukuro Main Store** + **Sunshine 60 Sky Circus** (till 22:00). ⚠ **Dinner: NOT Mutekiya** (pure tonkotsu, nothing for Candice). Pick **Kura Sushi** (bikkura-pon prize game — kids love it), **Sushiro**, **Ippudo** (tori-paitan for Candice), or **AFURI** (chicken-yuzu shio). Eat FIRST, fed by ~18:00.',
          '**C — Early night at Yotsuya** if they\'re cooked. Day 4 is teamLab Planets (booked 14:00) and wants fresh legs.',
          '**Decide after lunch** based on energy — then ping the planner to lock the pick into this page.',
        ],
        mapQuery: 'Akihabara Electric Town',
        mapLabel: 'Akihabara in Maps',
        accent: 'warn',
      },
      {
        emoji: '🚇',
        ...
        time: 'after dinner',
        lines: [
          'From **Akihabara**: JR Chuo-Sobu or Marunouchi via Otemachi back to Yotsuya, ~20 min.',
          'From **Ikebukuro**: Marunouchi line **Ikebukuro → Yotsuya-sanchome**, ~15 min direct, ¥220, no transfer.',
          'Day-2 lesson: kids hard-fade after ~7pm — aim home by ~21:00. Day 4 morning can be slow (teamLab booked 14:00).',
        ],
      },
    ],
    plan: [
