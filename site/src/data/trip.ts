...
export const DAYS: Day[] = [
  ...
  },
  {
    ...
    date: '2026-06-04',
    shortDate: 'Thu Jun 4',
    title: 'Hakone → Kyoto · Gion district loop',
    cluster: 'Transit in by noon, then one flat walking loop through Gion — scenery, gardens, geisha, street food, kaiseki',
    crossLinks: [
      { href: '/lodging/kyoto', label: '🏠 Stitch' },
      { href: '/transit', label: '🧳 Bags/Transit' },
      { href: '/bookings', label: '✈ Bookings' },
      { href: '/emergency', label: '🆘 Emergency' },
    ],
    locked: [
      '~10:11 — Shinkansen Hikari 637 Odawara → Kyoto (Car 14, seats 3ABC/3D/2D, Smart-EX res 2001) → arrive ~12:12',
      'On arrival at Stitch: ask front desk to BOOK tonight\'s kaiseki (Giro Giro Hitoshina, Kiyamachi) + confirm Hakone takkyubin arrived',
    ],
    prep: {
      title: 'Getting out of Hakone (depends on the typhoon\'s tail)',
      items: [
        '🚞 **Kowakudani → Odawara:** Tozan to Yumoto → Odawara. ⚠️ If the Tozan line is still recovering from the storm, take the **Hakone Tozan Bus or a taxi** to Odawara — leave a buffer; the Shinkansen is the fixed point (~10:11).',
        '🍱 **Buy ekiben at Odawara** for the train — Odawara\'s kamameshi bento is a good one. ~66-min buffer between arrival and Shinkansen is comfortable.',
        '👜 **Takkyubin Leg 2 bags** should already be at Stitch (or carry them today if you couldn\'t ship in the storm — you\'re going there anyway).',
        '🍽️ **Tonight = kaiseki #1 of 2** (Day 9 is the formal farewell). Casual *counter* kaiseki tonight suits tired kids; save the splurge for Day 9.',
      ],
    },
    momentCards: [
      {
        emoji: '🚄',
        title: 'Shinkansen Odawara → Kyoto (BOOKED)',
        time: '~10:11 → 12:12',
        lines: [
          '**Hikari 637** · Car 14 · seats **3A/B/C/D + 2D** · Smart-EX res **2001** · ~2h. (Hikari only — Nozomi skips Odawara.)',
          'Ekiben + green tea aboard. Pokémon GO won\'t track at 270km/h — download a show/episode for the kids before boarding.',
          'Mt. Fuji is on the **right (north) side** leaving Odawara — if it\'s cleared after the storm, watch for it early in the ride.',
        ],
        mapQuery: 'Odawara Station shinkansen',
        mapLabel: 'Odawara Station',
        accent: 'accent',
      },
      {
        emoji: '🏠',
        title: 'Arrive Kyoto → Stitch (drop bags)',
        time: '~12:35',
        lines: [
          'Kyoto Station → Stitch: Karasuma subway to Shijo + 5-min walk, or ~¥1,500 taxi. Shimogyo-ku, 2 min from Hankyu Kawaramachi.',
          'Formal check-in is 3pm, but front desk holds bags — you\'re free to head out immediately.',
          '**At the desk, right away:** ① **book tonight\'s kaiseki** (Giro Giro Hitoshina — see dinner card), ② confirm the Hakone takkyubin bags arrived, ③ ask about the Day 9 farewell-kaiseki booking while you\'re there.',
        ],
      ...
      {
        emoji: '🍢',
        title: 'Lunch — Nishiki Market street-food graze',
        time: '~12:45–13:45',
        lines: [
          '**Nishiki Market** — 5-min walk west. The street-food grazing stop: skewers, tamago, **tako-tamago** (baby octopus), soy-milk donuts, pickles, mochi. Graze, don\'t commit (Day-3 lesson).',
          '🐖 **Candice-safe** — tons of seafood/veg/chicken; she eats freely. Kids pick their own skewers.',
          'Covered arcade — fine even if the typhoon\'s tail leaves Kyoto drizzly.',
        ],
      ...
      {
        emoji: '🌿',
        title: 'Into Gion — Shirakawa Canal + Hanamikoji',
        time: '~14:00–14:40',
        lines: [
          'Cross **Shijo Bridge** into Gion.',
          '**Shirakawa Canal** — willow-lined, stone-paved; the prettiest scenery in Gion. Photos here.',
          '**Hanamikoji-dori** — the classic teahouse street (quiet by day; you return at dusk for the maiko window).',
        ],
        mapQuery: 'Shirakawa Canal Gion Kyoto',
        mapLabel: 'Shirakawa Canal',
        accent: 'accent',
      },
      {
        emoji: '🐉',
        title: 'Kennin-ji — Twin Dragons + Zen garden',
        time: '~14:40–15:40',
        lines: [
          'South end of Hanamikoji. Kyoto\'s **oldest Zen temple** — the **Twin Dragons ceiling** is the kid hook (huge, dramatic), plus the famous ○△□ garden and Cho-on-tei garden.',
          '¥800 adult / ¥300 elementary. **Last entry 16:30.** Socks-on, smooth floors — calm, ~45 min.',
          'This is the keeper garden — visually driven, not a contemplative slog (decision #7).',
        ],
      ...
      {
        emoji: '🍵',
        title: 'Kodai-ji + Ishibei-koji (optional — drop if kids fade)',
        time: '~15:50–16:45',
        lines: [
          'Walk up via **Ishibei-koji**, a gorgeous preserved stone alley. **Kodai-ji** — hillside Zen garden + bamboo path. ¥600. **Last entry 17:00.**',
          '⚠️ **Droppable:** two temples back-to-back risks kid boredom. If energy\'s low, skip straight to Yasaka → dusk → dinner. (No night illumination in June — daytime visit only.)',
        ],
      ...
      },
      {
        ...
        time: '~16:45–17:30',
        lines: [
          '**Yasaka Shrine** — free, always open; vermilion gate + hundreds of lanterns. Flows into **Maruyama Park**.',
          '**Imo Pi-pi** purple-potato ice cream nearby (P3) — the kid treat / crash-time reserve.',
        ],
        mapQuery: 'Yasaka Shrine Kyoto',
        mapLabel: 'Yasaka Shrine',
      },
      {
        emoji: '👘',
        title: 'Maiko window — back to Hanamikoji at dusk',
        time: '~17:45–18:15',
        lines: [
          'Return to **Hanamikoji / Shirakawa** at dusk — when maiko & geiko hurry between teahouse appointments. This is the best (and respectful) time to glimpse them.',
          '⚠️ **Etiquette:** Hanamikoji is a private street — **no photographing maiko without permission, don\'t follow or crowd them.** Shirakawa Canal is the calmer, photogenic spot to wait.',
        ],
        mapQuery: 'Hanamikoji Dori Gion Kyoto',
        mapLabel: 'Hanamikoji',
        accent: 'accent',
      },
      {
        emoji: '🍽️',
        title: 'Dinner — kaiseki (counter-style)',
        time: '~18:30–20:00',
        lines: [
          '⭐ **Giro Giro Hitoshina** (Kiyamachi, along the canal near Pontocho) — **counter-style kaiseki**, lively not hushed, creative multi-course, ~¥4,000–5,000. The kid-tolerant way to do kaiseki on an arrival night. **Have Stitch book it on arrival.**',
          '🐖 **Candice:** kaiseki is naturally seafood/veg/seasonal — confirm no-pork courses when booking; easy here.',
          '**This is kaiseki #1** — the formal farewell kaiseki (Kikunoi Roan / Kiyamachi Sakuragawa) is **Day 9**, so keep tonight relaxed.',
          'Fallbacks if Giro Giro is full: a **Pontocho** counter (P1) — pick one with chicken/seafood/sukiyaki — or 料理屋 てら戸 (sushi, 8 seats, needs booking).',
        ],
        mapQuery: 'Giro Giro Hitoshina Kyoto',
        mapLabel: 'Giro Giro Hitoshina',
        accent: 'accent',
      },
      {
        emoji: '🌙',
        ...
        time: '~20:00',
        lines: [
          'Stroll the **Kamo River** / Pontocho lanterns on the walk home (~10 min to Stitch).',
          'Optional adults-only nightcap at **L\'Escamoteur** (cocktail bar, open Thu) if Popo takes the kids back.',
          'Early-ish night — Day 8 has the Fushimi Inari sunrise option + GEAR show in the evening.',
        ],
    ...
    plan: [
      'Shinkansen Hikari 637 Odawara → Kyoto ~10:11 → 12:12 (bus/taxi to Odawara if Tozan still storm-hit).',
      'Stitch: drop bags → book tonight\'s kaiseki + confirm takkyubin.',
      'Nishiki Market street-food lunch → Shirakawa Canal → Hanamikoji → Kennin-ji (Twin Dragons + garden).',
      'Optional Kodai-ji via Ishibei-koji → Yasaka Shrine + Maruyama Park → Imo Pi-pi.',
      'Dusk maiko window on Hanamikoji → kaiseki dinner (Giro Giro Hitoshina, counter-style) → Kamo River walk home.',
    ],
    nextDayTeaser: 'Tomorrow → Day 8: Fushimi Inari sunrise (Keihan direct) · slow midday · Higashiyama stone-streets (Kiyomizu + Ninenzaka/Sannenzaka) · GEAR show 19:00 (booked).',
  },
  {
    n: 8,
    date: '2026-06-05',
