...
export const DAYS: Day[] = [
  ...
  },
  {
    ...
    momentCards: [
      ...
      {
        emoji: '🍣',
        title: 'Dinner — play it by ear (Kaikaya or Gyopao)',
        lines: [
          '**Option A — Kaikaya by the Sea** (Shibuya, ~10 min walk from Sky). 23-7 Maruyamacho. Seafood izakaya, lively. *Closed Wed.* Sat hours 17:00–22:30. **No reservation made — call ahead from the Sky line** if you want to lock a table.',
          '**Option B — Gyopao Gyoza** (Shinjuku, on the way home). Pandora B1, 3-23-12 Shinjuku, 2 min from Shinjuku Station East Exit. Walk-in works, kid-friendly soup dumplings. Sat 12:00–23:30.',
          'Decide based on kid energy at 19:30: still going → Kaikaya; tired/cranky → Gyopao on the way back.',
        ],
        tel: { number: '+81337700878', label: 'Kaikaya: 03-3770-0878 (call ahead from Sky line)' },
        mapQuery: 'Kaikaya by the Sea Shibuya Maruyamacho',
        mapLabel: 'Kaikaya in Maps',
      },
      {
        emoji: '🥟',
        title: 'Dinner fallback — Gyopao Gyoza (Shinjuku)',
        lines: [
          'Walk-in on the way home: Pandora Building B1, 3-23-12 Shinjuku, 2 min from Shinjuku Station East Exit. Sat 12:00–23:30.',
        ],
        mapQuery: 'Gyopao Gyoza Shinjuku Pandora B1',
        mapLabel: 'Gyopao in Maps',
      },
    ],
    plan: [
...
export const BOOKINGS: Booking[] = [
  ...
  { what: 'Shibuya Sky (sunset)', when: 'Sat May 30, ~18:00–18:30', status: 'to-book', notes: 'Window opened May 16 (2 weeks pre-date). Book via shibuya-sky.com / Klook / KKday. 5 tickets.' },
