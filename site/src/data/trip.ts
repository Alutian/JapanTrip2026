...
export const DAYS: Day[] = [
  ...
  },
  {
    ...
    locked: [
      ...
      '🧳 Retrieve Popo\'s stored bag from NRT T1 counter THIS EVENING — counters are NOT 24/7 (1F ~06:30–late, 4F 07:00–21:00). Morning is too tight: taxi arrives ~05:40 but counter opens 06:30 and Scoot check-in closes 07:20. Check her claim ticket for the exact counter + hours.',
    ],
    plan: [
      ...
      '~14:30–16:45 Akihabara (Yamanote, 4 min, daylight): Radio Kaikan (souvenirs/figures), Gachapon Kaikan (kids capsule haul), Don Quijote (snacks/grandma gifts), Yodobashi electronics / arcades',
