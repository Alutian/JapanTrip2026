    ...
    momentCards: [
      ...
      },
      {
        ...
        lines: [
          ...
          '**Nakamise Street** → souvenir + snack stalls (P1). **Candice pork pre-check** on meat-stick stalls.',
          '**Senso-ji** → main temple courtyard, omikuji fortunes (kids love it)',
          '**Hoppy Street** → atmospheric alley behind Senso-ji',
          '**Funawa Nakamise** → P6 imo-yokan (sweet potato dessert) on the walk back through Nakamise. ¥350-ish, kids friendly.',
      ...
      },
      {
        ...
        lines: [
          ...
          '**Skytree observation deck** (P6) — Tembo Deck only: ¥2,100 adult / ¥950 child (walk-up day-of). Combo with **Sumida Aquarium** ~¥3,400 adult / ¥2,500 child. **Cash budget: ~¥15-17k for the 5.**',
          'Aquarium is on **floors 4-5 of Skytree Town Solamachi** (separate building, walkable from Skytree base). Kid-magnet — penguins, jellyfish tunnel. ~1.5 hours.',
      ...
      },
      {
        ...
        lines: [
          ...
          '⭐ **Top pick — Kura Sushi Ikebukuro.** Conveyor belt + tablet + **bikkura-pon: every 5 plates dropped in the table slot triggers a capsule-toy prize game.** Kids 7+9 will lose their minds (food.md flag). Multiple Ikebukuro locations within 10 min of Sunshine City. Walk-in. Candice picks plates around any pork.',
          '⭐ **Alt — Sushiro at/near Sunshine City** — same conveyor-belt format, no prize toy but use Sushiro app to join waitlist remotely. Walk-in works for early dinner.',
          '⭐ **Ramen alt — Ippudo Ikebukuro.** Real tonkotsu shop where Candice can order **tori-paitan (chicken creamy)** or shio at the same table. Family eats together.',
          '⭐ **Ramen alt — AFURI Ikebukuro.** Chicken-yuzu shio, light, everyone safe.',
        ...
        mapQuery: 'Kura Sushi Ikebukuro',
        mapLabel: 'Kura Sushi Ikebukuro in Maps',
        accent: 'accent',
      },
      {
        emoji: '🎮',
